...
const (
	...
	SGD_AES_ECB   = 0x00004001
	SGD_AES_CBC   = 0x00004002
	SGD_AES_CFB   = 0x00004004
	SGD_AES_OFB   = 0x00004008
	SGD_AES_MAC   = 0x00004010
	SGD_AES_CTR   = 0x00004020
	SGD_RSA       = 0x00010000
	SGD_RSA_SIGN  = 0x00010100
	SGD_RSA_ENC   = 0x00010200
	SGD_SM2       = 0x00020100	// 椭圆曲线签名算法
	SGD_SM2_1     = 0x00020100	// 椭圆曲线签名算法
	SGD_SM2_2     = 0x00020200	// 椭圆曲线密钥交换算法
	SGD_SM2_3     = 0x00020400	// 团圆曲线加密算法
	SGD_SM9       = 0x00100000
